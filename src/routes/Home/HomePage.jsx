    ...
    <>
      ...
      <Layout title="This is title" urlBg={bgImg3}>
        <p>
          ...
          adjacent to an opponent`&apos;`s card whereupon the
          `&qout;`ranks`&qout;` of the sides where the two cards touch will be
          compared. If the rank of the opponent`&apos;`s card is higher than the
          player`&apos;`s card, the player`&apos;`s card will be captured and
          turned into the opponent`&apos;`s color. If the player`&apos;`s rank
          is higher, the opponent`&apos;`s card will be captured and changed
